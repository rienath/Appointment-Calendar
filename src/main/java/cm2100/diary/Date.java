...
public class Date implements Comparable<Date> {
    ...
    // Default values of year, month and day represent current date.
    // Since GUI needs to show calendar with current date and have a "Today" button,
    // default values witch current date were introduced.
    private int year = Calendar.getInstance().get(Calendar.YEAR);
    private int month = Calendar.getInstance().get(Calendar.MONTH) + 1;         // +1 since Calendar.MONTH starts with 0
    ...
    /**
     * Creates a Date object with specified year, month and date.
    ...
    /**
     * Creates a Date object with default values of year, month and day (current date).
     */
    public Date() {
    }
